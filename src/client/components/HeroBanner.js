  ...
  static SLIDER_CONTENTS = [
    {
      ...
      defaultTitle: 'Search for awesome Open Source projects on Crowdin',
    ...
    },
    {
      ...
      defaultTitle: 'Get your work reviewed by the DaVinci curation initiative',
      className: 'HeroBannerSlider__image',
      number: 2,
    },
    {
      ...
      defaultTitle: 'Get rewarded for your hard work!',
      className: 'HeroBannerSlider__image',
      number: 3,
    },
  ];
